...
const SignupScreen = () => {
    ...
    const onChangeGender = useCallback(gender => {
        setGender(gender);
    }, [])
    const onChangeMajor = useCallback(major => {
        setMajor(major);
    }, [])
    const onChangeEmail = useCallback(email => {
        setEmail(email);
    }, [])
    const onChangeEmailPassword = useCallback(email_password => {
        setEmailPassword(email_password);
    }, [])

    const handleChangeId = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeId && onChangeId(e.nativeEvent.text)
        },
        [onChangeId]
    )
    const handleChangeUsername = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeUsername && onChangeUsername(e.nativeEvent.text)
        },
        [onChangeUsername]
    )
    ...
    const handleChangePassword = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangePassword && onChangePassword(e.nativeEvent.text)
        },
        [onChangePassword]
    )
    const handleChangeGender = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeGender && onChangeGender(e.nativeEvent.text)
        },
        [onChangeGender]
    )
    const handleChangeMajor = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeMajor && onChangeMajor(e.nativeEvent.text)
        },
        [onChangeMajor]
    )
    const handleChangeEmail = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeEmail && onChangeEmail(e.nativeEvent.text)
        },
        [onChangeEmail]
    )
    const handleChangeEmailPassword = useCallback(
        (e: NativeSyntheticEvent<TextInputChangeEventData>) => {
            onChangeEmailPassword && onChangeEmailPassword(e.nativeEvent.text)
        },
